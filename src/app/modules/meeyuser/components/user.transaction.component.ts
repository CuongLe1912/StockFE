...
@Component({
    selector: 'ml-user-transaction',
    templateUrl: '../../../_core/components/grid/grid.component.html',
})
export class MLUserTransactionComponent extends GridComponent implements OnInit {
    obj: GridData = {
        Exports: [],
        Imports: [],
        Filters: [],
    ...
    async ngOnInit() {
        this.setPageSize(20);
        this.obj.Url = '/admin/MPTransactions/Items/' + this.item.Id;
