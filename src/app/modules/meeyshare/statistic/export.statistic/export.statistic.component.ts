...
import { MeeyShareExportStatisticEntity } from '../../../../_core/domains/entities/meeyshare/ms.export.statistic';
...
export class ExportStatisticComponent extends EditComponent {
    disabled: boolean;
    item: MeeyShareExportStatisticEntity = new MeeyShareExportStatisticEntity();
    ...
    public async confirm(): Promise<boolean> {
        if (this.item) {
            ...
            if (valid) {
                ...
                let obj = {
                    type: this.item.Type.map(c => parseInt(c.toString())),
                ...
                let fileName = 'Baocao.xlsx',
                    url = '/admin/meeyShareStatistic/export';
