...
import { MeeyReviewExportStatisticEntity } from '../../../../_core/domains/entities/meeyreview/ms.export.statistic';
...
export class ExportStatisticMRVComponent extends EditComponent {
    disabled: boolean;
    item: MeeyReviewExportStatisticEntity = new MeeyReviewExportStatisticEntity();
        ...
        if (this.item) {
            ...
            if (valid) {
                ...
                let fileName = 'Baocao.xlsx',
                    url = '/admin/meeyreview/ExportManage';
