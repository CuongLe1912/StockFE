...
import { MSMetaSeoV2HistoryComponent } from "./components/history.meta.seo.v2.component";

@Component({
    templateUrl: "../../../_core/components/grid/grid.component.html",
})
export class MSMetaSeoV2Component extends GridComponent {
    obj: GridData = {
        Reference: MSMetaSeoV2Entity,
        ...
        CustomFilters: ['FilterUpdateDate', 'Type', 'Need'],
    };
    ...
    async ngOnInit() {
        this.properties = [
            ...
            {
                Property: 'Category', Title: 'Danh mục', Type: DataType.String, DisableOrder: true,
                Format: (item: any) => {
            ...
            {
                Property: 'Url', Title: 'Url', Type: DataType.String, Align: 'center', DisableOrder: true, Click: ((item: any) => {
            ...
            {
                Property: 'UpdatedDate', Title: 'Ngày cập nhật', Type: DataType.String, DisableOrder: true,
                Format: (item: any) => {
        ...
        //this.obj.Url ='/admin/msmetaseo/itemsv2';
    ...
    edit(item: any) {
        let obj: NavigationStateData = {
            ...
            prevUrl: '/admin/msseo/metaseov2',
        };
        this.router.navigate(['/admin/msseo/metaseov2/edit'], { state: { params: JSON.stringify(obj) } });
    }
    ...
    history(item: any) {
        this.dialogService.WapperAsync({
            ...
            object: MSMetaSeoV2HistoryComponent,
