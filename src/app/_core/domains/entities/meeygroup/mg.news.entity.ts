...
import { MGCategoryEntity } from "./mg.category.entity";
...
export class MGNewsEntity extends BaseEntity {
    ...
    @DropDownDecorator({ label: 'Chủ đề', required: true, lookup: LookupData.Reference(MGCategoryEntity, ['NameVn', 'NameEn']) })
    CategoryId: number;
